...
jacks_character = Character.create(player_id: jack.id, name: Faker::Games::ElderScrolls.name, gender: Faker::Gender.type, pc: false, cclass: Faker::Games::DnD.klass, race: races.sample, background: Faker::Games::DnD.background, alignment: Faker::Games::DnD.alignment, strength: 13, dexterity: 14, constitution: 8, intelligence: 15, wisdom: 10, charisma: 12)
